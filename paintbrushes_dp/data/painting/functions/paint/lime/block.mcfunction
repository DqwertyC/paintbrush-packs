execute if block ~ ~ ~ #painting:shulker_box run function painting:paint/lime/shulker_box
execute if block ~ ~ ~ #painting:banner run function painting:paint/lime/banner
execute if block ~ ~ ~ #painting:wall_banner run function painting:paint/lime/wall_banner
execute if block ~ ~ ~ #painting:bed run function painting:paint/lime/bed
