execute if block ~ ~ ~ #painting:shulker_box run function painting:paint/light_gray/shulker_box
execute if block ~ ~ ~ #painting:banner run function painting:paint/light_gray/banner
execute if block ~ ~ ~ #painting:wall_banner run function painting:paint/light_gray/wall_banner
execute if block ~ ~ ~ #painting:bed run function painting:paint/light_gray/bed
