execute if block ~ ~ ~ #painting:shulker_box run function painting:paint/purple_shulker_box
execute if block ~ ~ ~ #painting:banner run function painting:paint/purple_banner
execute if block ~ ~ ~ #painting:wall_banner run function painting:paint/purple_wall_banner
