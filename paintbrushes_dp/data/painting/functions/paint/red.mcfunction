execute if block ~ ~ ~ #painting:shulker_box run function painting:paint/red_shulker_box
execute if block ~ ~ ~ #painting:banner run function painting:paint/red_banner
execute if block ~ ~ ~ #painting:wall_banner run function painting:paint/red_wall_banner
