execute if block ~ ~ ~ #painting:shulker_box run function painting:paint/pink_shulker_box
execute if block ~ ~ ~ #painting:banner run function painting:paint/pink_banner
execute if block ~ ~ ~ #painting:wall_banner run function painting:paint/pink_wall_banner
