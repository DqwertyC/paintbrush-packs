execute if block ~ ~ ~ #painting:shulker_box run function painting:paint/magenta/shulker_box
execute if block ~ ~ ~ #painting:banner run function painting:paint/magenta/banner
execute if block ~ ~ ~ #painting:wall_banner run function painting:paint/magenta/wall_banner
execute if block ~ ~ ~ #painting:bed run function painting:paint/magenta/bed
