execute if block ~ ~ ~ #painting:shulker_box run function painting:paint/brown_shulker_box
execute if block ~ ~ ~ #painting:banner run function painting:paint/brown_banner
execute if block ~ ~ ~ #painting:wall_banner run function painting:paint/brown_wall_banner
