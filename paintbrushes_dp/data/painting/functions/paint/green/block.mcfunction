execute if block ~ ~ ~ #painting:shulker_box run function painting:paint/green/shulker_box
execute if block ~ ~ ~ #painting:banner run function painting:paint/green/banner
execute if block ~ ~ ~ #painting:wall_banner run function painting:paint/green/wall_banner
execute if block ~ ~ ~ #painting:bed run function painting:paint/green/bed
